...
public final class DemoTeam {
  ...
  private static final List<Player> JUVENTUS_PLAYERS = List.of(
  ...
  private static final List<Player> MILAN_PLAYERS = List.of(
  ...
  private static final List<Player> INTER_PLAYERS = List.of(
  ...
  private static final List<Player> NAPOLI_PLAYERS = List.of(
