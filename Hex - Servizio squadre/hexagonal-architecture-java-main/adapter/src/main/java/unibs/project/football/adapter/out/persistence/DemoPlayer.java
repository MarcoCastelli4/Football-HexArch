...
public final class DemoPlayer {
  ...
  static {
    ...
    // Player for Juventus
    Player player1 = new Player("Juventus", "Cristiano Ronaldo", "Striker", 700, 36, "Male", 187, 83, injuries1, oldTeams1);
    ...
    // Player for Milan
    Player player2 = new Player("Milan", "Zlatan Ibrahimovic", "Striker", 550, 39, "Male", 195, 95, injuries2, oldTeams2);
    ...
    // Player for Inter
    Player player3 = new Player("Inter", "Romelu Lukaku", "Striker", 400, 28, "Male", 190, 94, injuries3, oldTeams3);
    ...
    // Player for Juventus
    Player player4 = new Player("Juventus", "Leonardo Bonucci", "Defender", 40, 36, "Male", 187, 83, injuries4, oldTeams4);
    ...
    // Player for Milan
    Player player5 = new Player("Milan", "Alvaro Morata", "Striker", 90, 36, "Male", 187, 83, injuries5, oldTeams5);
    ...
    // Player for Juventus
    Player player6 = new Player("Inter", "Bobo Vieri", "Striker", 700, 36, "Male", 187, 83, injuries6, oldTeams6);
